	...
	digestion_type(digestion_type)
{
	if (bodymass_adult <= 0.0)
		throw std::invalid_argument(
				"Fauna::GetDigestiveLimitIllius1992::GetDigestiveLimitIllius1992() "
...
const ForageEnergy GetDigestiveLimitIllius1992::operator()(
	...
	if (bodymass <= 0.0)
		throw std::invalid_argument("Fauna::GetDigestiveLimitIllius1992::operator()() "
	...
	if (!initialized){
		if (FORAGE_TYPES.size() > 1) // change this if adding new forage types
			throw std::logic_error(
					"Fauna::GetDigestiveLimitIllius1992::operator()() "
