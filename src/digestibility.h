...
class DigestibilityFromNPP : public GetDigestibility {
 public:
   ...
   */
  static double get_digestibility_from_dnpp(const std::deque<double>& weights,
                                            const double dig_fresh,
...
// vegetation dynamics. Ecological Modelling, 263, 92 - 102. Bredon, R.M.,
// Wilson, J., 1963. The chemical composition and nutritive value of grasses
// from semi-arid areas of Karamoja as related to ecology and types of soil. E.
// Afr. Agric. For. J. 29, 134–142. Prins, Herbert (1996). Ecology and behaviour
// of the African buffalo: social inequality and decision making. Springer
// Science \& Business Media Smallegange, I. M., & Brunsting, A. M. (2002). Food
// supply and demand, a simulation model of the functional response of grazing
// ruminants. Ecological modelling, 149(1), 179-192. van Wijngaarden, Willem
// (1985). Elephants-trees-grass-grazers. Relationships between climate, soils,
// vegetation and large herbivores in a semi-arid savanna ecosystem (Tsavo,
// Kenya). ITC
