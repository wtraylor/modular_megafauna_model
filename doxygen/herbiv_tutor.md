...
- Create a new `TableFile` member variable in \ref GuessOutput::HerbivoryOutput.
	...
	+ Add it in the private function `HerbivoryOutput::get_tablefiles()`.
	...
	Add this parameter to your instruction file and to the default example fie: `data/ins/herbiv_output.ins`.
- Extend the appropriate container: \ref FaunaOut::HabitatData or \ref FaunaOut::HerbivoreData by a new variable.
